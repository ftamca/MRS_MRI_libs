...
This fork contains modifications (circa September 2020) to support MRS thermometry at SRI, MRUI data import, more apodizing filter types, and Hz-points-ppm conversion. The code was used in:
...
Documentation on preparing for and running the MRS thermometry pipeline is [in the Wiki](https://github.com/ftamca/MRS_MRI_libs/wiki/Documentation).
